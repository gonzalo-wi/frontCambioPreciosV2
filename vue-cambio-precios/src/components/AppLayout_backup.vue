  ...
  <div class="flex h-screen bg-gray-50">
    ...
    <div class="flex">
      ...
      >
        ...
        <!-- Header del sidebar -->
        <div class="flex items-center justify-between p-4 border-b border-blue-600/30 relative z-10">
          <div v-show="sidebarAbierto" class="flex items-center space-x-3">
            <div class="w-10 h-10 rounded-full overflow-hidden logo-container sidebar-logo">
              <img 
            ...
            <div>
              <h1 class="text-lg font-bold text-white">Precios App</h1>
          ...
          <div v-show="!sidebarAbierto" class="mx-auto">
            <div class="w-8 h-8 rounded-full overflow-hidden logo-container sidebar-logo">
              <img 
                src="../assets/images.jpeg" 
                alt="Logo" 
                class="w-full h-full object-cover"
